// Sydney Freshers Festival · Local Schools Edition · English player
...
let i = 0;
const pdfHref = '../pdf-output/sydney-local-schools-en.pdf';
...
// Slide overview
if (ovTitle) ovTitle.textContent = 'All ' + N + ' slides · Select to jump';
slides.forEach((s, n) => {
...
// Click to navigate unless editing text
