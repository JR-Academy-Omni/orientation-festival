		...
		<div style={{
			...
			>
				<img
					...
					alt="Melbourne three-university orientation festival welcome illustration"
			...
			<motion.div
				...
				style={{
					...
					fontFamily: fonts.mono, fontSize: 15, fontWeight: 700, letterSpacing: 1.5,
				}}>
				2026 S2 · 6th Orientation Festival · Partner Proposal
			</motion.div>

			<h1 style={{ margin: 0, fontFamily: fonts.heading, fontWeight: 900, color: colors.white, fontSize: 82, lineHeight: 1.02, letterSpacing: -2, maxWidth: 640 }}>
