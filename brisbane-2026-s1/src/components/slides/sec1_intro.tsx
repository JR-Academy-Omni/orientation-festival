		...
		<Page tag="01 · 活动概览" title="一场触达三校新生的品牌主场">
			<div style={{ display: 'grid', gridTemplateColumns: '1.05fr 0.95fr', gap: 24, flex: 1, minHeight: 0 }}>
				<div style={{ display: 'flex', flexDirection: 'column', gap: 16, minHeight: 0 }}>
					...
					{[['📅', '8/21 周五 2PM–5PM'], ['📍', 'Market Square'], ['🎓', 'UQ · QUT · Griffith']].map(([k, v]) => (
...
export function S03_Intro() {
	...
	return (
		<Page tag="02 · 活动介绍" title={<>第 6 届「布里斯班三校<span style={{ color: colors.red }}>新生节</span>」</>}
			bg={colors.dark} tone="dark" accent={colors.yellow} watermark="03" align="center">
			<Editorial tone="dark" accent={colors.red} size={31}>
				第 6 届布里斯班三校新生节聚焦 UQ、QUT、Griffith 新生，在开学季把学生、城市生活资源和本地品牌放到同一个现场。活动预计 <b style={{ color: colors.yellow }}>1000 名学生</b>到场，设置室内展位、礼品派发、抽奖互动和面对面咨询。对品牌来说，这是在学生刚抵达城市时建立认知、获取线索、沉淀私域的集中窗口——{hl('曝光、互动、转化在同一场完成')}。
			</Editorial>
		</Page>
	);
}
